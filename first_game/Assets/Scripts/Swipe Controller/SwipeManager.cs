...
public class SwipeManager : MonoBehaviour
{
    ...
    [SerializeField] [Range(0.1f, 30f)] private float maxtapTime = 0.5f;

    [Tooltip("Maximum time for recognizing a swipe")] //live_HOCOK
    [SerializeField] [Range(0.1f, 1f)] private float maxswipeTime = 0.5f;
    ...
    private void TriggerSwipes()
    {
        ...
        if (finalLengthOfSwipe > minSwipeLength && totalDurationOftouch < maxswipeTime)
        {
    ...
    private void StartTapSequence()
    {
        ...
        if (totalDurationOftouch < maxtapTime && totalDurationOftouch > maxswipeTime) //live_HOCOK
        {
